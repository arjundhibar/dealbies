...
export function ProfileHeader({
  ...
  return (
    <div className="w-screen -mt-4 -ml-28 pt-8 bg-white dark:bg-[#1d1f20] border-b border-gray-200 dark:border-gray-800">
      <div className="w-[1000px] mx-auto px-4 py-6">
        <Card className="border-0 rounded-2xl shadow-none bg-[rgba(15,55,95,0.05)] relative">
            ...
            <div className="flex flex-col justify-center items-center gap-6 pt-10">
              ...
              <div className="relative -mt-20 z-10">
                <Avatar className="h-24 w-24  shadow-lg">
                  ...
                  />
                  <AvatarFallback className="h-20 w-20 text-2xl font-bold bg-gray-200 dark:bg-gray-700">
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex flex-col items-center gap-6 text-sm text-gray-600 dark:text-gray-400">
                  {/* Registration Date */}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>{loading ? "..." : `${commentsCount} comments`}</span>
                  </div>
