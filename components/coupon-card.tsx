...
import { MessageSquare, ExternalLink, ChevronUp, ChevronDown, Share2, MessagesSquare, ArrowBigDown, ArrowBigUp, Copy, Check } from "lucide-react"
            ...
            <div className="w-[75%] p-2 flex flex-col dark:bg-[#1d1f20]">
              <div className="flex-grow">
                ...
                <div className="text-sm text-muted-foreground mb-1 leading-none">
                  Available at <Badge variant="outline" className="text-sm bg-white dark:text-white dark:bg-dark-secondary">
                  {merchant}
                </Badge>
                </div>
              ...
              <div className="flex gap-2 mt-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="flex-1 border-dashed border-[#f7641b] text-[#f7641b] hover:bg-[#f7641b] hover:text-white rounded-[50vh] h-9 px-4"
                  onClick={handleCopyCode}
                >
                  <span className="text-[0.875rem] font-bold">{discountCode}</span>
                  {copied ? (
                ...
                <Button
                  variant="default"
                  size="sm"
                  className="bg-[#f7641b] hover:bg-[#eb611f] active:bg-[#da5a1c] shadow-[#f7641b] hover:shadow-[#eb611f] rounded-[50vh] h-9 px-4"
                  onClick={handleUseCode}
                >
                  <span className="text-[0.875rem] font-bold text-white">Use</span>
            ...
            <div className="flex items-center justify-between mt-4 pt-1">
              ...
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="border-dashed border-[#f7641b] text-[#f7641b] hover:bg-[#f7641b] hover:text-white rounded-[50vh] h-9 px-4"
                  onClick={handleCopyCode}
                >
                  <span className="text-[0.875rem] font-bold">{discountCode}</span>
                  {copied ? (
