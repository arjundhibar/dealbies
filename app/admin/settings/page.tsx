...
import { SchemaMarkupForm } from "@/components/admin/schema-markup-form";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Email notification settings will be implemented in a future
              update.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Backup and restore functionality will be implemented in a future
              update.
            </p>
          </CardContent>
        </Card>
