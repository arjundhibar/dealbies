...
export default function PostDiscountCodePage() {
  ...
  const [duplicateDeal, setDuplicateDeal] = useState<DuplicateDeal | null>(
    null
  );
  ...
  function renderCase0Mobile() {
    return (
      <div
        className="flex flex-col items-center justify-center flex-1 !m-0 !p-0 animate-fade-in-up px-4"
        ...
        <div className="w-full max-w-2xl text-center space-y-8">
          <div className="space-y-4 pt-3">
            ...
            <p className="text-lg font-poppins text-[rgba(4,8,13,0.59)] dark:text-[hsla(0,0%,100%,0.75)]">
              Paste the link where other people can buy the deal or find more
              information.
            </p>
          </div>
          <div className="space-y-6">
            <div className="flex flex-col items-center space-y-3 w-full">
              ...
              <Button
                ...
                disabled={
                  (!discountlinkValue.trim() && !discountCode.trim()) ||
                  isLoading
                }
              ...
              <div className="bg-[#28292a] rounded-lg p-4 space-y-4">
                <div className="space-y-2 text-left">
                  ...
                  <p className="text-gray-300 text-base text-left">
                    It looks like this offer has already been posted or is being
                    reviewed. Duplicate deals are usually removed.
                  </p>
                </div>
                <div className="dark:bg-[#1d1f20] p-2 rounded-lg flex items-center space-x-4 relative">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-medium text-base text-left">
                      {duplicateDeal.title}
                    </h4>
                    <div className="flex items-center space-x-2 mt-1 gap-1">
                      {duplicateDeal.price && (
                        <span className="dark:text-[#f97936] text-base font-medium">
                          ₹{duplicateDeal.price}
                        </span>
                      )}
                      {duplicateDeal.merchant && (
                        <span className="dark:text-[#f97936] text-base">
                          {duplicateDeal.merchant}
                        </span>
                      )}
                      {duplicateDeal.createdAt && (
                        <span className="dark:text-[hsla(0,0%,100%,0.75)] text-base">
                          {formatDistanceStrict(
                            new Date(duplicateDeal.createdAt),
                            new Date(),
                            { addSuffix: true }
                          )}
                        </span>
            ...
            {currentStep === 0 && !isLoading && !duplicateDeal && (
              <button
                onClick={handleNext}
                className="text-[#6b6d70] hover:text-[#76787b] dark:text-[#c5c7ca] h-9 px-4 dark:hover:text-[#babcbf] hover:bg-[rgba(15,55,95,0.05)] dark:hover:bg-[hsla(0,0%,100%,0.05)] hover:rounded-full text-sm font-semibold w-full"
              >
  ...
  function renderCase0Desktop() {
    return (
      <div
        className="flex flex-col items-center justify-center flex-1 !m-0 !p-0 animate-fade-in-up min-h-screen w-full"
        style={{ animationDelay: "0.1s", animationFillMode: "both" }}
      >
        <div className="w-full max-w-2xl text-center space-y-8">
          <div className="space-y-4">
            <h1 className="text-[32px] leading-[2.625rem] font-poppins font-medium text-[#000] dark:text-[#fff]">
              Share a discount code with millions of people
            </h1>
          ...
          <div className="space-y-6">
            ...
            {currentStep === 0 && !isLoading && !duplicateDeal && (
              <button
                onClick={handleNext}
                className="text-[#6b6d70] hover:text-[#76787b] dark:text-[#c5c7ca] h-9 px-4 dark:hover:text-[#babcbf] hover:bg-[rgba(15,55,95,0.05)] dark:hover:bg-[hsla(0,0%,100%,0.05)] hover:rounded-full text-sm font-semibold"
              >
                I don't have a code or link
              </button>
            )}
  ...
  function renderCase1Mobile() {
    return (
      <div
        className="w-full max-w-2xl !mx-auto space-y-8 px-2"
        style={{ animationDelay: "0.1s", animationFillMode: "both" }}
      >
        <div className="w-full max-w-2xl mx-auto space-y-8">
          ...
          <div className="">
            <div className="flex justify-between items-center">
              <label className="dark:text-white text-black text-sm font-semibold pb-[1.75px]">
                discount code title{" "}
                <span className="text-[rgba(4,8,13,0.59)] dark:text-[hsla(0,0%,100%,0.75)] font-normal">
                  (required)
                </span>
              </label>
          ...
          <div className="">
            <h2 className="text-xl font-semibold dark:text-white text-black pb-4">
              Discount type{" "}
              <span className="text-sm text-[rgba(4,8,13,0.59)] dark:text-[hsla(0,0%,100%,0.75)] font-normal">
                (required)
              </span>
            </h2>
          ...
          : "border-[rgba(3,12,25,0.23)] dark:border-[hsla(0,0%,100%,0.35)]"
              ...
              {discountType === "percentage" && (
                <div className="relative w-[200px] mt-1">
                  <span className="absolute left-14 top-1/2 transform -translate-y-1/2 text-gray-400">
                    %
                  </span>
                  <Input
                    type="number"
          ...
          <div className="space-y-4">
            ...
            {availability === "offline" ? (
              <div className=" rounded-lg relative">
                <label className="dark:text-white text-sm font-semibold pb-[1.75px]">
                  Select location(s)
                </label>
                <Input
                  value={shippingFrom}
  ...
  function renderCase3Mobile() {
    return (
      <div
        className="flex items-center justify-center flex-1 p-2 animate-fade-in-up"
        style={{ animationDelay: "0.1s", animationFillMode: "both" }}
      >
  ...
  function renderCase3Desktop() {
    ...
    return (
      <div
        className="flex items-center justify-center flex-1 p-2 md:p-0 animate-fade-in-up min-h-screen w-full"
        style={{ animationDelay: "0.1s", animationFillMode: "both" }}
      >
        <div className="max-w-[682px] w-full space-y-8">
          {/* Header */}
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 1:
        return (
          <>
            <div className="block md:hidden h-auto overflow-y-auto p-2">
              {renderCase1Mobile()}
            </div>
            ...
            <div className="max-w-[682px] space-y-8 w-full">
              <div className="text-left mt-8 md:mt-28 space-y-6">
                ...
                <p className="text-base md:text-lg text-[rgba(4,8,13,0.59)] dark:text-[hsla(0,0%,100%,0.75)]">
                  Upload up to 8 images to post your discount code. You can drag
                  and drop to rearrange them and choose the cover.
                </p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto border border-dashed border-[rgba(9,24,47,0.13)] dark:border-[hsla(0,0%,100%,0.18)] p-4 rounded-lg">
                ...
                {/* Empty slots */}
                {Array.from({
                  length: Math.max(0, 8 - uploadedImages.length),
                }).map((_, index) => {
                  const isCenter = uploadedImages.length === 0 && index === 4; // Center position when no images
                  const showUploadButton =
                    uploadedImages.length === 0 ? isCenter : index === 0;
              ...
              <div className="space-y-2">
                <h3 className="text-[12.25px] font-bold text-[#000] dark:text-[#fff]">
                  Upload via URL
                </h3>
                <div className="relative pb-[40px]">
                  ...
                  <Button
                    ...
                    disabled={
                      !imageUrlInput.trim() || uploadedImages.length >= 8
                    }
          ...
          >
            <div className="max-w-[682px] w-full space-y-8">
              ...
              <div className="text-start mt-2 md:-mt-20">
                <h1 className="text-2xl md:text-[32px] font-semibold text-[#000] dark:text-[#fff]">
                  Final details
                </h1>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[12.25px] font-bold text-[#000] dark:text-[#fff]">
                    Starting day
                  </label>
          ...
          >
            <div className="max-w-[682px] w-full space-y-2 mb-[84px]">
              ...
              <div className="text-left mt-8 md:mt-28 space-y-8 mb-5">
                <h1 className="text-3xl md:text-5xl font-semibold text-[#000] dark:text-[#fff]">
                  Check your discount code
                </h1>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex flex-col items-start p-6 border rounded-lg dark:border-[hsla(0,0%,100%,0.18)] space-y-6">
                  <h2 className="text-2xl font-bold text-[#000] dark:text-[#fff]">
                    Link & code
                  </h2>
                  <h4 className="text-base font-semibold text-[#000] dark:text-[#fff] mb-1">
                    Link
                  </h4>
                  <div className="text-base text-[#000] dark:text-[#fff] break-all">
                    {discountlinkValue || "example.com"}
                  </div>
                  <div>
                    <h4 className="text-base font-semibold text-[#000] dark:text-[#fff] mb-1">
                      Discount code
              ...
              <div className="space-y-4">
                <div className="flex flex-col items-start p-6 border rounded-lg dark:border-[hsla(0,0%,100%,0.18)] space-y-6">
                  ...
                  <div className="space-y-6 w-full">
                    <div>
                      <h3 className="text-base font-semibold text-[#000] dark:text-[#fff] mb-1">
                        Title of discount code
                      </h3>
                      <p className="text-sm text-[#000] dark:text-[#fff]">
                        {discount || "No title provided"}
                      </p>
                    </div>
                    <div>
                      <h4 className="text-base font-semibold text-[#000] dark:text-[#fff] mb-1">
              ...
              <div className="space-y-4">
                <div className="flex flex-col items-start p-6 border rounded-lg dark:border-[hsla(0,0%,100%,0.18)] space-y-6">
                  <h2 className="text-xl font-semibold text-[#000] dark:text-[#fff]">
                    Description
                  </h2>
              ...
              <div className="space-y-4">
                <div className="flex flex-col items-start p-6 border rounded-lg dark:border-[hsla(0,0%,100%,0.18)] space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                    <div>
                      <h4 className="text-sm font-medium text-[#000] dark:text-[#fff] mb-1">
                        Starting day
                      </h4>
                      <p className="text-sm text-[#000] dark:text-[#fff]">
                        {startDate || "-"}
